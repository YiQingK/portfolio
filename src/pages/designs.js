...
const projects = () => {
    return (
        <>
            <Head>
                <title> Yi Qing | Designs Page</title>
                    ...
                    <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
                        <div className="col-span-12">
                            <FeaturedProject
                                ...
                                img={project1}
                                link="/designs/h2games"
                                github="/"
                                type="Featured Banner Design Work"
                                summary="Banner design work for H2 Games GameJam event with Nanyang Polytechnic (NYP) in Singapore."
                            />
                        </div>
