                ...
                <Layout>
                    ...
                    <div className="grid grid-cols-12 gap-24 gap-y-24 xl:gap-x-16 lg:gap-x-8 sm:gap-x-0">
                        <div className="col-span-8">
                            ...
                            <ul className="list-disc ml-4"><li className="list-item font-bold">Features of the game</li></ul>
                            <p className="ml-8">When creating the low-fidelity sketches, the prototype team were unsure of what features should be included in the design.
                                We had discussions such as whether to include global interaction or how progress should be tracked.
                                After listening to our team which had conducted the user interviews, it affirmed our idea of having a platform for all users to interact as well as changing a leveling system to a categorical tracker.
                            </p>
                            <ul className="list-disc ml-4"><li className="list-item font-bold">Navigating the prototype</li></ul>
                        ...
                        <div className="col-span-12">
                            ...
                            <h2 className="font-bold uppercase text-lg my-4" >Process</h2>
                            <ol className="list-decimal ml-8">
                                <li className="list-item">Created an open-ended survey to understand the factors that contribute to participants feeling safe within online spaces while also recruiting participants for our in-person focus group workshops.</li>
                                <li className="list-item">Created a focus group protocol - group discussion and design session to have a deeper dive into safety in online experiences as well as to understand what features participants might find helpful in promoting online interactions.</li>
                                <li className="list-item">Revised survey and protocol with feedback from Professors and fellow research lab members.</li>
